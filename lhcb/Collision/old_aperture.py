...
data=np.loadtxt(r'../../elements/out/aperture_b1_mqxa.csv',delimiter=',',dtype=str)
...
data=np.loadtxt(r'../../elements/out/aperture_b1_mqxb.csv',delimiter=',',dtype=str)
...
# data=np.loadtxt(r'../../elements/out/aperture_b1_vacuum.csv',delimiter=',',dtype=str)  
# n,s0,l0=[],[],[]
# for d in data:
#   a=str(d[0])
#   s0=float(d[1])
...
data=np.loadtxt(r'../../elements/out/aperture_b1_b.csv',delimiter=',',dtype=str)  
n,s0,l0=[],[],[]
for d in data:
  a=str(d[0])
  s0=float(d[1])
