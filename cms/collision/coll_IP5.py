...
beams.beam1x(r'madx/survey_lhcb1.tfs',r'madx/coll_b1_ip5.tfs')
beams.beam2x(r'madx/survey_lhcb2.tfs',r'madx/coll_b2_ip5.tfs')
...
elem.plotelem(r'../../elements/out/aperture_b1_mbx.csv',D,t[2],e[1]) 
elem.plotelem(r'../../elements/out/aperture_b1_mbxw.csv',D,t[2],e[1]) 
elem.plotelem(r'../../elements/out/aperture_b1_mbrc.csv',D,t[2],e[2]) 
elem.plotelem(r'../../elements/out/aperture_b1_mbrs.csv',D,t[2],e[3]) 
# elem.plotelem(r'../../elements/out/aperture_b1_mbw.csv',D,t[2],e[0]) 
elem.plotelem(r'../../elements/out/aperture_b1_mbrb.csv',D,t[2],e[4]) 
elem.plotelem(r'../../elements/out/aperture_b1_mqxa.csv',Q1,t[2],e[0]) 
elem.plotelem(r'../../elements/out/aperture_b1_mqxb.csv',Q2,t[2],e[5]) 
# elem.plotelem(r'../../elements/out/aperture_b1_mc.csv',M,t[2],e[0]) 
# elem.plotelem(r'../../elements/out/aperture_b1_mk.csv',M,t[2],e[0]) 
elem.plotelem(r'../../elements/out/aperture_b1_tc.csv',TC,t[2],e[0]) 
# elem.plotelem(r'../../elements/out/aperture_b1_b.csv',B,t[2],e[0]) 
elem.plotelem(r'../../elements/out/aperture_b1_tan.csv',TAN,t[2],e[0]) 
elem.plotelem(r'../../elements/out/aperture_b1_tas.csv',TAN,t[2],e[0]) 
# elem.plotv(r'../../elements/out/aperture_b1_v.csv',V,t[2],e[0]) 
